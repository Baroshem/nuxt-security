...
describe('[nuxt-security] Per-route Configuration', async () => {
  ...
  it('sets default headers for the homepage', async () => {
    ...
    expect(csp).toBe("base-uri 'none'; default-src 'self'; connect-src 'self' https:; font-src 'self' https: data:; img-src 'self' data:; object-src 'none'; script-src-attr 'none'; style-src 'self' https: 'unsafe-inline'; script-src 'self' https: 'unsafe-inline' 'strict-dynamic'; upgrade-insecure-requests;")
    expect(oac).toBe('?1')
  ...
  it('finds security headers provided as standard headers', async () => {
    ...
    expect(coop).toBe('same-origin')
    expect(coep).toBe('require-corp')
    expect(csp).toBe("base-uri 'none'; default-src 'self'; connect-src 'self' https:; font-src 'self' https: data:; img-src 'self' data:; object-src 'none'; script-src-attr 'none'; style-src 'self' https: 'unsafe-inline'; script-src 'self' https:; upgrade-insecure-requests; media-src 'none';")
    expect(oac).toBe('?1')
    expect(rp).toBe('no-referrer')
  ...
  it('is backwards-compatible with deprecated object syntax for standard headers', async () => {
    ...
    expect(coop).toBe('same-origin')
    expect(coep).toBe('require-corp')
    expect(csp).toBe("default-src 'self'; connect-src 'self' https:; font-src 'self' https: data:; img-src https:; object-src 'none'; script-src-attr 'none'; style-src 'self' https: 'unsafe-inline'; script-src 'self'; upgrade-insecure-requests;")
    expect(oac).toBe('?1')
    expect(rp).toBe('no-referrer')
  ...
  it('is backwards-compatible with deprecated string syntax for security headers', async () => {
    ...
    expect(coop).toBe('same-origin')
    expect(coep).toBe('require-corp')
    expect(csp).toBe("base-uri 'none'; default-src 'self'; connect-src 'self' https:; font-src 'self' https: data:; img-src 'self' data:; object-src 'none'; script-src-attr 'none'; style-src 'self' https: 'unsafe-inline'; script-src 'self'; upgrade-insecure-requests; manifest-src 'none';")
    expect(oac).toBe('?1')
    expect(rp).toBe('no-referrer')
  ...
  */
  ...
  it('supports substitution merging via the string syntax', async () => {
    ...
    expect(csp).toBe("base-uri 'none'; default-src 'self'; connect-src 'self' https:; font-src 'self' https: data:; img-src blob:; object-src 'none'; script-src-attr 'none'; style-src 'self' https: 'unsafe-inline'; script-src 'self' https: 'unsafe-inline' 'strict-dynamic'; upgrade-insecure-requests;")

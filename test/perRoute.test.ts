...
describe('[nuxt-security] Per-route Configuration', async () => {
  ...
  it('sets default headers for the homepage', async () => {
    ...
    expect(csp).toBe("base-uri 'none'; default-src 'none'; connect-src 'self' https:; font-src 'self' https: data:; form-action 'self'; frame-ancestors 'self'; frame-src 'self'; img-src 'self' data:; manifest-src 'self'; media-src 'self'; object-src 'none'; script-src-attr 'none'; style-src 'self' https: 'unsafe-inline'; script-src 'self' https: 'unsafe-inline' 'strict-dynamic'; upgrade-insecure-requests; worker-src 'self';")
    expect(oac).toBe('?1')
  ...
  it('finds security headers provided as standard headers', async () => {
    ...
    expect(coop).toBe('same-origin')
    expect(coep).toBe('require-corp')
    expect(csp).toBe("base-uri 'none'; default-src 'none'; connect-src 'self' https:; font-src 'self' https: data:; form-action 'self'; frame-ancestors 'self'; frame-src 'self'; img-src 'self' data:; manifest-src 'self'; media-src 'none'; object-src 'none'; script-src-attr 'none'; style-src 'self' https: 'unsafe-inline'; script-src 'self' https:; upgrade-insecure-requests; worker-src 'self';")
    expect(oac).toBe('?1')
    expect(rp).toBe('no-referrer')
  ...
  it('is backwards-compatible with deprecated object syntax for standard headers', async () => {
    ...
    expect(coop).toBe('same-origin')
    expect(coep).toBe('require-corp')
    expect(csp).toBe("default-src 'none'; connect-src 'self' https:; font-src 'self' https: data:; form-action 'self'; frame-ancestors 'self'; frame-src 'self'; img-src https:; manifest-src 'self'; media-src 'self'; object-src 'none'; script-src-attr 'none'; style-src 'self' https: 'unsafe-inline'; script-src 'self'; upgrade-insecure-requests; worker-src 'self';")
    expect(oac).toBe('?1')
    expect(rp).toBe('no-referrer')
  ...
  it('is backwards-compatible with deprecated string syntax for security headers', async () => {
    ...
    expect(coop).toBe('same-origin')
    expect(coep).toBe('require-corp')
    expect(csp).toBe("base-uri 'none'; default-src 'none'; connect-src 'self' https:; font-src 'self' https: data:; form-action 'self'; frame-ancestors 'self'; frame-src 'self'; img-src 'self' data:; manifest-src 'none'; media-src 'self'; object-src 'none'; script-src-attr 'none'; style-src 'self' https: 'unsafe-inline'; script-src 'self'; upgrade-insecure-requests; worker-src 'self';")
    expect(oac).toBe('?1')
    expect(rp).toBe('no-referrer')
